  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        {/* Semi-transparent overlay for readability - making it more transparent */}
        <Box 
          sx={{
            position: 'absolute',
            top: 0,
        ...
        {/* Image title and description - floating at right bottom corner with subtle styling */}
        <Box
          sx={(theme) => ({
            position: 'absolute',
      ...
      {/* Dots for navigation - floating at bottom left with subtle styling */}
      <Stack 
        direction="row" 
        spacing={1}
        sx={{ 
